...
Border _getButtonBorder(
  ...
  Color color = themeData.color.secondary;

  if (disabled) color = themeData.color.background02;
  if (heldDown) color = themeData.color.secondaryShade;
...
Color _getSpinKitColor(BuildContext context) {
  ...
  return themeData.color.secondary;
}
...
class BWSecondaryButton extends StatefulWidget {
  ...
  @override
  State<BWSecondaryButton> createState() => _BWSecondaryButtonState();
}

class _BWSecondaryButtonState extends State<BWSecondaryButton> {
  // 是否按下按鈕
